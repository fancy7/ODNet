...
class PatchEmbed(nn.Module):
    def __init__(self, input_shape=[20, 20], patch_size=1, in_chans=512, num_features=512, norm_layer=None, flatten=True):
        super().__init__()
...
class SATS1(nn.Module):
    def __init__(
            self, input_shape=[20, 20], patch_size=1, in_chans=512, num_classes=8, num_features=512,
        ...
        num_patches         = (20 // patch_size) * (20 // patch_size)
        self.num_features   = num_features
        self.new_feature_shape = [int(input_shape[0] // patch_size), int(input_shape[1] // patch_size)]
        self.old_feature_shape = [int(20 // patch_size), int(20 // patch_size)]

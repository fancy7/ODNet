...
class PatchEmbed(nn.Module):
    def __init__(self, input_shape=[80, 80], patch_size=1, in_chans=128, num_features=128, norm_layer=None, flatten=True):
        super().__init__()
...
class SATS3(nn.Module):
    def __init__(
            self, input_shape=[80, 80], patch_size=1, in_chans=128, num_classes=8, num_features=128,
            depth=1, num_heads=1, mlp_ratio=4., qkv_bias=True, drop_rate=0.1, attn_drop_rate=0.1, drop_path_rate=0.1,
        ...
        num_patches         = (80 // patch_size) * (80 // patch_size)
        self.num_features   = num_features
        self.new_feature_shape = [int(input_shape[0] // patch_size), int(input_shape[1] // patch_size)]
        self.old_feature_shape = [int(80 // patch_size), int(80 // patch_size)]

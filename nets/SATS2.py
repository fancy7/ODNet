...
class PatchEmbed(nn.Module):
    def __init__(self, input_shape=[40, 40], patch_size=1, in_chans=256, num_features=256, norm_layer=None, flatten=True):
        super().__init__()
...
class SATS2(nn.Module):
    def __init__(
            self, input_shape=[40, 40], patch_size=1, in_chans=256, num_classes=8, num_features=256,
        ...
        num_patches         = (40 // patch_size) * (40 // patch_size)
        self.num_features   = num_features
        self.new_feature_shape = [int(input_shape[0] // patch_size), int(input_shape[1] // patch_size)]
        self.old_feature_shape = [int(40 // patch_size), int(40 // patch_size)]
